...
include("langmuirs2.jl")
include("langmuirs3.jl")
include("langmuirs4.jl")
include("langmuirs5.jl")
include("null.jl")
include("langmuir_freundlich.jl")
include("langmuir_freundlichs2.jl")
include("langmuir_freundlichs3.jl")
include("langmuir_freundlichs4.jl")
include("langmuir_freundlichs5.jl")
